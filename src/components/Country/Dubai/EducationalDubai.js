      ...
      <div class="relative flex min-h-screen flex-col justify-center overflow-hidden   sm:py-12">
        <div class="w-full items-center mx-auto max-w-screen-lg">
                      ...
                      <ul class="mt-2 list-disc px-2 pl-6">
                        <li className="text-white">
                          ...
                          >
                            ...
                            <br></br> UG programme : Overall 6.0 with at-least
                            5.5 in each component.<br></br>
                            PG programme : Overall 6.5 with at-least 6.0 in each
                            component.
                          </a>
                        </li>
                      </ul>
                      ...
                      <ul class="mt-2 list-disc px-2 pl-6">
                        <li className="text-white">
                          ...
                          >
                            ...
                            <br></br> UG programme: Overall 51 with at-least 51
                            in each component.<br></br>
                            PG programme: Overall 58 with at-least 51 in each
                            component.
                          </a>
                        </li>
                      </ul>
                      <ul class="mt-2 list-disc px-2 pl-6">
                        <li className="text-white">
                          <a
                            ...
                            href="#introduction"
                          >
                            <span className="font-bold">Duolingo :</span> A
                            minimum score of 105 is required for the Duolingo
                            English Test
                          </a>
                        </li>
                      </ul>
                      <ul class="mt-2 list-disc px-2 pl-6">
                        <li className="text-white">
                          <a
                            ...
                            href="#introduction"
                          >
                            <span className="font-bold">TOEFL :</span> A minimum
                            of 550 on the paper-based TOEFL; 213 on the
                            computer-based test; and 79 on the Internet-based
                            test.
                          </a>
                        </li>
                      </ul>
          ...
          <span className="text-white text-lg">
            Ensure you meet these academic prerequisites to pursue your
            educational goals seamlessly. Contact us for further guidance and
...
export default EducationalDubai;

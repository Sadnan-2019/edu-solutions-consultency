...
import "./CyprusLanding.css"
const CyprusLanding = () => {
    return (
        <div>
              <div className="relative">
        <div className="absolute  cyprus inset-0 overflow-hidden">
          {/* Background image */}
          <img
        ...
        <div className="relative z-10 flex flex-col items-center justify-center min-h-screen text-white">
          ...
          <p className="text-4xl font-bold mb-4">
            Explore Cyprus education opportunities from Bangladesh
          </p>
          {/* Image sections */}
        </div>
      </div>

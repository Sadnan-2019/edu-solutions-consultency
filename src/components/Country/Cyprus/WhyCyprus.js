        ...
        <div class="max-w-3xl mx-auto">
          <div class="  bg-white rounded-b lg:rounded-b-none lg:rounded-r flex flex-col justify-between leading-normal">
            <div class="">
              ...
              Cyprus has become a popular destination among international
              ...
              Cyprus is home to prestigious universities, with six of them
              ...
              <p class="text-base leading-8 my-5  ">
                ...
                2 years of post-study work rights in Cyprus.
              </p>
              <h3 class="text-2xl font-bold my-5">3.Best Student City</h3>
              <p class="text-base leading-8 my-5">
              Nicosia, one of Cyprus major cities, is ranked as one of the
              ...
              <p class="text-base leading-8 my-5">
                ...
                headquarters in Cyprus, providing job opportunities.
              </p>
              <h3 class="text-2xl font-bold my-5">5.Scholarships</h3>
              <p class="text-base leading-8 my-5">
               Cyprus offers attractive scholarships for eligible international students.
              </p>
               
              <h3 class="text-2xl font-bold my-5">5.Cost of Studying and Living</h3>
              <p class="text-base leading-8 my-5">
              The cost of studying in Cyprus ranges from approximately €6,000 to €14,000.
              </p>
              <p class="text-base leading-8 my-5">
              Living expenses may amount to around €3,000 to €5,000.
              </p>

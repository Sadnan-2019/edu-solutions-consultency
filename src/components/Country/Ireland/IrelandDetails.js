...
import InstitutionalIreland from './InstitutionalIreland';
import EducationalIreland from './EducationalIreland';

const IrelandDetails = () => {
        ...
        <div className=" bg-gradient-to-r from-[#24348f] via-[#3342BF] to-[#080C24] via-[#098bdc] to-[#24348f]">
          <div className=" ">
            {activeDiv === 1 && (
              <div className=" ">
                {" "}
                <InstitutionalIreland></InstitutionalIreland>
              </div>
            )}
            {/* {activeDiv === 2 && (
            ...
            {activeDiv === 2 && (
              <div className=" p-4 rounded">
                {" "}
               <EducationalIreland></EducationalIreland>
              </div>
            )}
          </div>
        </div>

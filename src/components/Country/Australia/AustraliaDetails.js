...
import InstitutionalUk from '../UK/InstitutionalUk';
import EducationalUk from '../UK/EducationalUk';
import InstitutionalAU from './InstitutionalAU';
import EducationalAU from './EducationalAU';
...
const AustraliaDetails = () => {
  ...
  <li>
    <button
      className={`text-lg font-bold ${activeDiv === 1 ? "bg-red-900" : ""} text-white list-none hover:text-gray-900 py-2 px-4 rounded`}
      onClick={() => showDiv(1)}
    >
  ...
  <li>
    <button
      className={`text-lg font-bold ${activeDiv === 2 ? "bg-red-900" : ""} text-white list-none hover:text-gray-900 py-2 px-4 rounded`}
      onClick={() => showDiv(2)}
    >
      ...
      <div className=" bg-gradient-to-r from-[#24348f] via-[#3342BF] to-[#080C24] via-[#098bdc] to-[#24348f]">
        <div className=" ">
          {activeDiv === 1 && (
            <div className=" ">
              {" "}
              <InstitutionalAU></InstitutionalAU>
            </div>
          )}
          {/* {activeDiv === 2 && (

        ...
        <Marquee gradientColor={false} speed={80} gradient={false}>
          <div class=" ">
            ...
            <div class="flex  ">
              ...
              <div
                // style="box-shadow:0px 2px 4px rgba(0, 0, 0, 0.06), 0px 4px 6px rgba(0, 0, 0, 0.1)"
                class="mx-5  bg-gradient-to-r from-[#1AA855] via-[#051431] to-[#013125]    flex flex-col max-w-md align-center justify-between border border-solid border-gray-200 dark:border-dark    rounded-xl"
              >
                <div class="flex flex-col px-6 pt-8  space-y-5">
                  <svg
                    width="24"
              ...
              <div
                // style="box-shadow:0px 2px 4px rgba(0, 0, 0, 0.06), 0px 4px 6px rgba(0, 0, 0, 0.1)"
                class="mx-5  bg-gradient-to-r from-[#9d2626] via-[#051431] to-[#610303]    flex flex-col max-w-md align-center justify-between border border-solid border-gray-200 dark:border-dark    rounded-xl"
              >
                <div class="flex flex-col px-6 pt-8  space-y-5">
                  <svg
                    width="24"
